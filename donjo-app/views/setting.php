			...
			<div class="col-md-3">
				<div class="box box-primary">
					<div class="box-body box-profile">
						...
						<?php else: ?>
							<img class="profile-user-img img-responsive img-circle" src="<?= base_url()?>assets/files/user_pict/desa.png" alt="Foto">
						<?php endif; ?>
					</div>
				</div>
			</div>
			<div class="col-sm-9">
				<div class="box box-danger">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="catatan">Ulangi Password Baru</label>
						...
						<div class="form-group">
							...
							<div class="input-group input-group-sm">
								...
								<span class="input-group-btn">
									<button type="button" class="btn btn-info btn-flat"  id="file_browser"><i class="fa fa-search"></i> Cari File</button>
								</span>
							</div>
						</div>
					</div>
