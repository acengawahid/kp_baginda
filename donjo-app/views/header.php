	...
	<body class="<?= $this->setting->warna_tema_admin; ?> sidebar-mini fixed <?php if ($minsidebar==1): ?>sidebar-collapse<?php endif ?>">
		<div class="wrapper">
			<header class="main-header">
				<a href="<?=site_url()?>hom_sid"  target="_blank" class="logo">
					<span class="logo-mini"><b>BGN</b></span>
					<span class="logo-lg"><b>Desa Baginda</b></span>
				</a>
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									<li class="user-header">
										...
										<?php else :?>
											<img src="<?= base_url()?>assets/files/user_pict/desa.png" class="img-circle" alt="User Image"/>
										<?php endif; ?>
									...
									<li class="user-footer">
										<div class="pull-left">
											<a href="<?=site_url()?>user_setting/" data-remote="false" data-toggle="modal" data-tittle="Pengaturan Pengguna" data-target="#modalBox">
												<button  data-toggle="modal"  class="btn bg-blue btn-flat btn-sm" >Profil</button>
											</a>
										</div>
										<div class="pull-right">
											<a href="<?=site_url()?>first" class="btn bg-red btn-flat btn-sm">Logout</a>
										</div>
									</li>
								</ul>
							</li>
