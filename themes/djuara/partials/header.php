...
<body class="">
  <div class="header-top bg-dark" style="padding: 2px; color: #ffffff;">
    <div class="container">
      <table>
        <tr>
          <td><div class="label-runningtext">Info_Desa</div></td>
          <td width="100%">
  ...
  <header class="djuara-header">
   <nav class="navbar navbar-expand-lg bg-light" id="navbar">
    <div class="container"><a class="navbar-brand" href="<?= site_url('first');?>"><img id="logobrand" src="<?= LogoDesa($desa['logo']) ?>" height="50px" width="50px" /></a>
  ...
  <form action="<?= site_url('first');?>" method="get">
    ...
    <div class="searchbar">
      <input class="search_input" type="text" name="cari" placeholder="Cari...">
