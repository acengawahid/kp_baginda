            ...
            <div class="contact_bottom">
              <form class="contact_form form form col-md-8" id="form-komentar" name="form" action="<?= site_url('first/add_comment/'.$single_artikel['id'])?>" method="POST" onSubmit="return validasi(this);">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="owner" id="owner" maxlength="100" placeholder="Masukkan Nama" value="<?= !empty($_SESSION['post']['owner']) ? $_SESSION['post']['owner'] : $_SESSION['nama'] ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="no_hp" id="no_hp" maxlength="15" placeholder="Masukkan Nomor HP" value="<?= $_SESSION['post']['no_hp'] ?>">
                </div>
                <div class="form-group">
                ...
                <tr class="komentar alamat">
                  ...
                  <tr class="captcha_code">
                    <td>&nbsp;</td>
                    <td>
                      <input class="form-control" type="text" name="captcha_code" maxlength="6" value="<?= $_SESSION['post']['captcha_code']?>"/> Tuliskan kode di gambar
                    </td>
                  </tr>
                  <tr class="submit">
                    <td>&nbsp;</td>
